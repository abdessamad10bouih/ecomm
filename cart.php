            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <th scope="col"><a href="./detaille.php?RefPdt=<?php echo $row['RefPdt']; ?>"><i class="fa-solid fa-eye fa-xl" style="color: #000000; margin: 0px 10px;"></i></a><a href=""><i class="fa-solid fa-square-xmark fa-xl" style="color: #000000; margin: 0px 10px;"></i></a><a href=""><i class="fa-solid fa-rotate-right fa-xl" style="color: #000000; margin: 0px 10px;"></i></a></th>
                    </tr>;
                <?php
                }
